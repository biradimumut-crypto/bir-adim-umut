...
class _DashboardScreenState extends State<DashboardScreen> with TickerProviderStateMixin {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Row(
          ...
          children: [
            _buildNavItem(0, 'assets/icons/bagis.png', 'Bağış', 1),
            _buildNavItem(1, 'assets/icons/takım.png', 'Takım', 2),
            _buildCenterNavItem(),
            _buildNavItem(2, 'assets/icons/siralama.png', 'Sıralama', 3),
            _buildNavItem(3, 'assets/icons/Profil.png', 'Profil', 4),
          ],
        ),
      ),
    );
  ...
  Widget _buildNavItem(int visualIndex, String iconPath, String label, int actualIndex) {
          ...
          children: [
            ColorFiltered(
              colorFilter: ColorFilter.mode(
                isSelected ? const Color(0xFF6EC6B5) : Colors.grey[400]!,
                BlendMode.srcIn,
              ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? const Color(0xFF6EC6B5) : Colors.grey[300]!,
            width: 2,
          ),
        ),
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? const Color(0xFFFFF8E1) : Colors.grey[100],
            borderRadius: BorderRadius.circular(16),
          ),
          child: ColorFiltered(
            colorFilter: ColorFilter.mode(
              isSelected ? const Color(0xFFE07A5F) : Colors.grey[400]!,
              BlendMode.srcIn,
            ),
            child: Image.asset('assets/icons/anasayfa.png', width: 28, height: 28),
          ),
        ),
      ),
    );
