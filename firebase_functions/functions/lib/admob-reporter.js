...
const getAdMobOAuthClient = () => {
    ...
    const clientId = (_a = config.admob) === null || _a === void 0 ? void 0 : _a.client_id;
    const clientSecret = (_b = config.admob) === null || _b === void 0 ? void 0 : _b.client_secret;
    const refreshToken = (_c = config.admob) === null || _c === void 0 ? void 0 : _c.refresh_token;
    if (!clientId || !clientSecret || !refreshToken) {
        console.error("❌ AdMob OAuth config missing!");
        console.error('Set: admob.client_id, admob.client_secret, admob.refresh_token (firebase functions:config:set ...)');
        throw new Error("AdMob OAuth config missing. Please set admob.client_id, admob.client_secret, admob.refresh_token in Firebase Functions config.");
    }
        ...
        if (rows && rows.length > 0) {
            for (const row of rows) {
                if (row.row) {
                    ...
                    // Gösterim
                    const impressions = parseInt(((_b = metricValues.IMPRESSIONS) === null || _b === void 0 ? void 0 : _b.integerValue) || "0", 10);
                    // Format türü
...
exports.fetchAdMobRevenueManual = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        throw new functions.https.HttpsError("internal", (error === null || error === void 0 ? void 0 : error.message) || "Rapor çekilemedi");
    }
});
