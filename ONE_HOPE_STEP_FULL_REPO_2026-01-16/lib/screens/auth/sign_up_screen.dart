...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _handleSignUp(LanguageProvider lang) async {
    ...
    if (result['success']) {
      ...
      // NOT: Rozet ve referral işlemleri email doğrulamasından SONRA yapılacak
      // Email doğrulama KOD ekranına yönlendir
      if (mounted) {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (_) => EmailVerificationScreen(
              email: email,
              isNewUser: true, // Yeni kullanıcı flag'i
            ),
          ),
        );
      }
  ...
  /// Email doğrulama bilgilendirme dialog'u (BUG-004) - Artık kullanılmıyor
  Future<void> _showEmailVerificationInfoDialog(LanguageProvider lang) async {
    await showDialog(
      context: context,
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.mark_email_read, color: Color(0xFF6EC6B5), size: 28),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                lang.isTurkish ? 'Kayıt Başarılı! 🎉' : 'Registration Successful! 🎉',
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.info_outline, color: Color(0xFFE07A5F), size: 20),
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: const TextStyle(fontSize: 13, color: Color(0xFFE07A5F)),
                    ),
                  ),
                ],
              ),
        ...
        actions: [
          ElevatedButton(
            ...
            child: Text(lang.isTurkish ? 'Anladım' : 'Got it'),
          ),
        ],
      ),
    );
